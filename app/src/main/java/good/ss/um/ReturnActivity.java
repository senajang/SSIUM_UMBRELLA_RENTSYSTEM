...
public class ReturnActivity extends AppCompatActivity {
    ...
    btn_info.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            textViewUsingTime.setText(
                usingTime / 86400
                    + "일 "
                    + usingTime % 86400 / 3600
                    + "시 "
                    + usingTime % 3600 / 60
                    + "분 "
                    + usingTime % 3600 % 60
            ...
            userUmDb.addValueEventListener(
  ...
  private void returnUmbrella(
      int userId, String userName, String userUmbrella, String userLocation) {
        ...
        .addOnSuccessListener(
            new OnSuccessListener<Void>() {
              ...
              public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(
                        ReturnActivity.this,
                        "반납 신청이 완료되었습니다. 우산의 상태 확인 후 보증금이 반환됩니다.",
                        Toast.LENGTH_SHORT)
                    .show();
              }
            })
